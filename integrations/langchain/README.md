...
`[name="evidence"]`, `[accept="image/png,.pdf"]`,
`[capture="environment"]`, `[multiple="true"]`, `[enterkeyhint="next"]`, `[autocapitalize="none"]`,
`[dirname="field.dir"]`, `[spellcheck="false"]`, `[form="settings-form"]`,
`[list="email-suggestions"]`, `[target="_blank"]`, `[rel="noopener"]`,
`[download="report.csv"]`, `[popovertarget="panel-id"]`,
`[popovertargetaction="show"]`, `[commandfor="panel-id"]`,
`[button_type="submit"]`, `[formaction="/save"]`, `[formmethod="post"]`,
`[formenctype="application/x-www-form-urlencoded"]`, `[formtarget="_top"]`,
`[formnovalidate="true"]`,
`[command="toggle-popover"]`, `[accesskey="s"]`, `[maxlength="64"]`,
`[pattern="..."]`, `[invalid="grammar"]`, `[aria_autocomplete="list"]`,
`[aria_placeholder="Prompt text"]`, `[active_descendant="suggestion-1"]`,
...
`[multiselectable="true"]`, `[orientation="horizontal"]`, `[level="2"]`,
`[posinset="1"]`, `[setsize="3"]`, `[valuenow="40"]`,
