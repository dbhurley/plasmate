...
const NAV = [
  ...
  { slug: 'integration-llamaindex', label: 'LlamaIndex' },
  ...
  { slug: 'integration-openclaw', label: 'OpenClaw' },
  { section: 'Web Scraping' },
  { slug: 'integration-scrapy', label: 'Scrapy' },
  { section: 'Tools' },
  { slug: 'tools', label: 'Auditing & CI/CD' },
  { section: 'Coverage & Benchmarks' },
  { slug: 'claims', label: 'Claim & Evidence Registry' },
  { slug: 'coverage', label: 'Coverage (HTML)' },
  { slug: 'coverage-js', label: 'Coverage (JS)' },
  { slug: 'benchmark-cost', label: 'Archived Cost Analysis' },
